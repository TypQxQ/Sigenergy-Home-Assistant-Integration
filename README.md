...
a) Use the [GitHub discussions](https://github.com/TypQxQ/Sigenergy-Home-Assistant-Integration/discussions) 

b) Only if code-related (bugs/contributions): Open an  [GitHub issue](https://github.com/TypQxQ/Sigenergy-Home-Assistant-Integration/issues) or issue a pull request
...
I have a **Sigenergy SigenStor EC 15.0 TP** Inverter and **4 8kWh batteries** updating frequently to the latest version of **Home Assistant** (> 2025.4).
...
If there are newer versions available, ket me know vis GitHub discussions.
...
If you need have any questions, feature requests, found any bugs or have some hints how to update the documentation, just ask on Github Discussions.
